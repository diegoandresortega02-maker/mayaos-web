  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await createPatient({
        ...
        sensitivity_frio: null,
        sensitivity_calor: null,
        sensitivity_dulce: null,
        sensitivity_acido: null,
        sensitivity_percusion: null,
        sensitivity_sangrado: null,
        clinical_history_started_at: null,
        anamnesis_alergias: null,
        anamnesis_cirugias: null,
        anamnesis_medicamentos: null,
        anamnesis_anestesia: null,
        anamnesis_hemorragias: null,
        anamnesis_diabetes: null,
        anamnesis_hipertension: null,
        anamnesis_fiebre_reumatica: null,
        anamnesis_asma: null,
        anamnesis_vih_sida: null,
        anamnesis_cardiovascular: null,
        anamnesis_gastrointestinal: null,
        anamnesis_respiratoria: null,
        anamnesis_embarazo: null,
        anamnesis_enfermedad_grave_reciente: null,
        anamnesis_alcohol: null,
        anamnesis_tabaco: null,
        anamnesis_detalle: null,
      })
      onCreated()
    } catch (err) {
      console.error(err)
